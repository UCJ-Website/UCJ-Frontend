...
const management = [
  {
    ...
    desc: "The Director oversees the academic and administrative affairs of the college, ensuring the highest standards of education and governance.",
  },
  {
    slug: "admin-office",
    icon: "fa-pen-nib",
    title: "Administration",
    sub: "Assistant Registrar & General Office",
    desc: "Handles General Administration, Establishment, Student Admissions & Registration, and Student Affairs from the Ground Floor office, next to Reception.",
  },
  {
    slug: "finance",
    icon: "fa-coins",
    title: "Finance",
    sub: "Assistant Bursar Office",
    desc: "Prepares SLPSAS-compliant annual financial statements, manages budgets and payments, oversees capital works, and maintains the fixed asset register.",
  },
];
